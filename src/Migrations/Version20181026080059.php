 ...
 */
final class Version20181026080059 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE signalement (id INT AUTO_INCREMENT NOT NULL, sig_id_user_id INT NOT NULL, spot_id INT NOT NULL, sig_vide VARCHAR(255) NOT NULL, sig_toxique VARCHAR(255) NOT NULL, sig_desc VARCHAR(255) NOT NULL, sig_accessibilite VARCHAR(255) NOT NULL, INDEX IDX_F4B55114E3268119 (sig_id_user_id), INDEX IDX_F4B551142DF1D37C (spot_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, use_nom VARCHAR(255) NOT NULL, use_email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, use_profile_pic VARCHAR(255) DEFAULT NULL, use_role VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
