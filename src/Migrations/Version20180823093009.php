 ...
 */
final class Version20180823093009 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD use_role INT DEFAULT 0 NOT NULL, DROP use_role_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD use_role_id INT NOT NULL, DROP use_role');
